...
namespace mesh_smoothing {
    ...
    int inner_main(int argc, char* argv[])
    {
        using namespace Eigen;
        using namespace std;
        igl::readOFF(PathHelper::get_folder_path(__FILE__) + "/../../models/decimated-knight.off", V, F);
        U = V;
        igl::readDMAT(PathHelper::get_folder_path(__FILE__) + "/../../models/decimated-knight-selection.dmat", S);
